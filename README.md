...
Framework: Flutter (Dart Language) - Cross-platform mobile development

Database Lokal: Hive & Hive Flutter - NoSQL key-value database yang sangat ringan dan cepat
